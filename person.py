...
class Person:
    ...
    def load_by_id(search_id):
        ...
        for eintrag in person_data:
            ...
            return {1: "No Person with this ID found"}
    ...
    def calc_max_HR(self):
        ...
        if self.gender == "female":
            max_hr = 226 - 1.0 * self.age
        elif self.gender == "male":
            max_hr = 223 - 0.9 * self.age
        else:
            max_hr = "None"
...
if __name__ == "__main__":
    ...
    print(person_dict)
    person3 = Person(person_dict)
    print(person3.calc_age())
    print(person3.calc_max_HR())
